package fr.tractopelle.unclaimfinder.item;
...
public class RItemUnsafe {
    ...
    public String getString(String tag){
        return new fr.tractopelle.unclaimfinder.item.RNBItem(this.itemBuilder.toItemStack()).getString(tag);
    }

    public RItemUnsafe setString(String tag, String value){
        this.itemBuilder = new ItemBuilder(new fr.tractopelle.unclaimfinder.item.RNBItem(this.itemBuilder.toItemStack()).setString(tag, value).build());
        return this;
    }

    public RItemUnsafe setByte(String tag, byte b){
        this.itemBuilder = new ItemBuilder(new fr.tractopelle.unclaimfinder.item.RNBItem(this.itemBuilder.toItemStack()).setByte(tag, b).build());
        return this;
    }
    ...
    public RItemUnsafe setShort(String tag, short b){
        this.itemBuilder = new ItemBuilder(new fr.tractopelle.unclaimfinder.item.RNBItem(this.itemBuilder.toItemStack()).setShort(tag, b).build());
        return this;
    }
