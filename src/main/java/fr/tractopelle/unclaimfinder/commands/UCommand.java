package fr.tractopelle.unclaimfinder.commands;
...
public abstract class UCommand implements CommandExecutor {
    ...
    public UCommand(CorePlugin corePlugin, String commandName, boolean consoleCanExecute, String permission) {
